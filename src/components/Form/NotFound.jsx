        ...
        <div className="flex items-center justify-center py-12">
          <div className="bg-white border rounded-md flex items-center justify-center mx-4 md:w-2/3 ">
            <div className="flex flex-col items-center py-16 ">
              ...
              <Link to="/">
                <button className="mx-4 h-10 w-44 border rounded-md text-white text-base bg-lime-700 hover:bg-lime-800 focus:outline-none focus:ring-2 focus:ring-opacity-50 focus:ring-lime-800">
                  Go Back
                </button>
              </Link>
            </div>
