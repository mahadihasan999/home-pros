  ...
  return (
    <section className="">
      <div className="hidden lg:block md:block ">
        ...
        {/* //menu icons  */}
        <div
          className=" fixed bottom-10 left-10 bg-lime-200 p-2 rounded-full cursor-pointer shadow-xl border border-cyan"
          onClick={handlenav}
        >
          <img
      ...
      <div className="block md:hidden lg:hidden">
        ...
        {/* //menu icons  */}
        <div
          className=" fixed bottom-10 left-2 bg-lime-200  p-2 rounded-full cursor-pointer shadow-xl border border-cyan z-50"
          onClick={handlenav}
        >
          <img
            className={`${sidenav ? "hidden" : ""}`}
