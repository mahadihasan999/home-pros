...
const SingleBlogs = ({
  ...
  return (
    <tr className="h-24 border-lime-400  border">
      <td className="">
        <img src={image} alt={image} className="h-20 w-full" />
      </td>
      <td className="text-sm px-2 whitespace-no-wrap text-gray-800  tracking-normal leading-4 border-lime-400 border-l px-2">
        {index + 1}
      </td>

      <td className="text-sm px-2 whitespace-no-wrap text-gray-800  tracking-normal leading-4 text-left  border-lime-400 border-l px-2">
        {title}
      </td>
      <td className="text-sm px-2 whitespace-no-wrap text-gray-800  tracking-normal leading-4 text-left  border-lime-400 border-l px-2">
        {summary?.slice(0, 200)}...
      ...
      <td className="border-lime-400 border-l ">
