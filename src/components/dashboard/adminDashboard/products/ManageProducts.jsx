        ...
        <div className="mx-auto container">
          ...
          {loading ? (
            ...
            <div className="w-full overflow-x-scroll xl:overflow-x-hidden ">
              ...
              <table className="min-w-full border-2 border-lime-500 text-center">
                <thead>
                  <tr className="h-16 bg-lime-500 border py-8 text-center font-bold">
          ...
          <div className="pagination flex justify-center items-center my-6 ">
            {[...Array(pageCount).keys()].map((number) => (
              <button
                className={
                  number === page
                    ? "selected bg-lime-500 px-2 text-white mx-2 rounded"
                    : "bg-lime-200 text-gray-700 mx-2 px-2 rounded"
                }
                key={number}
