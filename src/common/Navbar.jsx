                ...
                <div className="inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-gray-100 focus:outline-none transition duration-150 ease-in-out">
                  <div className="visible xl:hidden">
                    <ul className="p-2 border-r bg-white absolute rounded left-0 right-0 shadow mt-8 md:mt-8 hidden">
                      <Link
                        to="/"
                        className="flex xl:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-lime-700 focus:text-lime-700 focus:outline-none"
                      >
                      ...
                      <Link
                        to="/properties"
                        className="flex xl:hidden flex-col cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-lime-700 focus:text-lime-700 focus:outline-none flex justify-center"
                      >
                        <div className="flex items-center">
                      ...
                      <Link className="flex xl:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-lime-700 flex items-center focus:text-lime-700 focus:outline-none">
                        <AiOutlineLayout className="text-xl text-gray-800" />
                        <span className="ml-2 font-bold">Blogs</span>
                      </Link>
                      <Link
                        to="/about"
                        className="border-b border-gray-300 flex xl:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal pt-2 pb-4 hover:text-lime-700 flex items-center focus:text-lime-700 focus:outline-none"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Link className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-lime-700 flex items-center focus:text-lime-700 focus:outline-none">
                        <div className="flex items-center">
                      ...
                      <Link className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-lime-700 focus:text-lime-700 focus:outline-none">
                        <div className="flex items-center">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="flex flex-col justify-between h-full w-full">
                  <div>
                    ...
                    <ul className=" flex-col flex">
                      ...
                      >
                        <div className="flex items-center">
                          <AiOutlineLayout className="w-6 h-6 md:w-8 md:h-8 text-gray-800" />
                          <p className="text-gray-800 xl:text-base md:text-2xl text-base ml-3">
                            Blogs
                          </p>
                        </div>
